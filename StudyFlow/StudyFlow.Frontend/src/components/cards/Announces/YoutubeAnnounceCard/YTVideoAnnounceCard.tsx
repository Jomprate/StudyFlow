...
import './ytvideoAnnounceCard.css';

interface VideoCardProps {
    url: string;
}

const YTVideoAnnounceCard: React.FC<VideoCardProps> = ({ url }) => {
    ...
    return (
        <a href={url} className="ytvideoAnnounceCard_video-card" target="_blank" rel="noopener noreferrer">
            <img src={defaultThumbnail} alt={title || "Video"} className="ytvideoAnnounceCard_video-thumbnail" />
            <div className="ytvideoAnnounceCard_video-details">
...
export default YTVideoAnnounceCard;