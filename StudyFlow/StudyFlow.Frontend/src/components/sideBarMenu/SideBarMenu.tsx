...
const SidebarMenu: React.FC<SidebarMenuProps> = ({ visible }) => {
    ...
    return (
        <div className={`custom-sidebar ${visible ? 'open' : 'collapsed'}`}>
            <nav>
                <ul>
                    {renderNavItem('/home_logged_in/mainloggedin', AiOutlineHome, t('Main'))}
                    {renderNavItem('/home_logged_in/courses', HiOutlineBookOpen, t('sideBar_loggedIn_Courses'))}
                    {renderCourses()}
                    {renderNavItem('/home_logged_in/calendar', BiCalendar, t('Calendar'))}
                    {renderNavItem('/home_logged_in/notifications', AiOutlineBell, t('Notifications'))}
                    {renderNavItem('/home_logged_in/requests', MdOutlineRequestPage, t('Requests'))}
                    {renderNavItem('/home_logged_in/settings', AiOutlineSetting, t('Settings'))}
                </ul>
            </nav>
        </div>
    );
