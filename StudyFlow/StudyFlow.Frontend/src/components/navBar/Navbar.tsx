...
const Navbar: React.FC = () => {
    ...
    const handleLanguageChange = (e: React.SyntheticEvent<HTMLElement>, { value }: any) => {
            ...
            <div className="sf__navbar">
                ...
                <div className="sf__navbar-sign-container">
                    <div className="sf__navbar-sign" style={{ marginLeft: '10px' }}>
                        ...
                        <button type="button" onClick={() => setOpenAuthModal(true)}>Sign up</button>
                    </div>
                </div>
