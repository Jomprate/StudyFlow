...
export {
    checkBackendStatus, // Verificación del estado del backend
    authApi,            // Funciones de autenticación
    userApi,            // Funciones de usuarios
    countryApi,         // Funciones de países
    announceApi,        // Funciones de anuncios
    courseApi           // Funciones de cursos
};
...
//    title: string;
//    htmlContent: string;
//    userId: string; // Ahora requerido
//    courseId: string; // Ahora requerido
...
//        // Inicializar arrays vacíos si están ausentes
