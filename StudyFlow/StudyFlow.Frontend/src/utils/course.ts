...
interface paginationResult {
    listResult: Array<Icourse>;
}
interface courseData {
    paginationResult: paginationResult;
}

const courseCrete = ({ userId, name, description }: Icourse) => {
    const body = {
        teacherDTO: {
            id: userId,
            fullName: 'string',
...
const courseUpdate = (id: string | undefined, { userId, description, name }: Icourse) => {
    const body = {
        id,
        teacherDTO: {
            id: userId,
